		...
		<div id="list-post" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreate" title="${message(code: 'post.dateCreate.label', default: 'Date Create')}" />
					
						<g:sortableColumn property="lastUpdate" title="${message(code: 'post.lastUpdate.label', default: 'Last Update')}" />
					
						<g:sortableColumn property="rate" title="${message(code: 'post.rate.label', default: 'Rate')}" />
				...
				<g:each in="${postInstanceList}" status="i" var="postInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${postInstance.dateCreate}" /></td>
					
						<td><g:formatDate date="${postInstance.lastUpdate}" /></td>
					
						<td>${fieldValue(bean: postInstance, field: "rate")}</td>
